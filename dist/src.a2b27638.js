...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"src/productos.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.obtenerBotonComprar = obtenerBotonComprar;
exports.obtenerNombreProducto = obtenerNombreProducto;
...
function obtenerNombreProducto(idProducto) {
  var producto = document.getElementById(idProducto); //return producto.children[1].textContent;

  var span = producto.children[0];
  var nombreProducto = span.textContent;
...
function obtenerBotonComprar(idProducto) {
  //Pendiente por hacer...
  var product = document.getElementById(idProducto);
  return product.children[1];
}
},{}],"src/carrito.js":[function(require,module,exports) {
"use strict";
 ...
 */
function agregarProducto(nombredelProducto) {
  //let product = document.getElementById("producto-1");
  //let hijo0 = product.children[0];
  var textHijo = (0, _productos.obtenerNombreProducto)(nombredelProducto);
  var nuevoSpan = document.createElement("p");
  var textoNuevo = document.createTextNode(textHijo);
...
},{"./productos":"src/productos.js"}],"node_modules/parcel-bundler/src/builtins/bundle-url.js":[function(require,module,exports) {
var bundleURL = null;
...
function clickBoton1() {
  (0, _carrito.agregarProducto)("producto-1");
}

function clickBoton2() {
  (0, _carrito.agregarProducto)("producto-2");
}

function clickBoton3() {
  (0, _carrito.agregarProducto)("producto-3");
}

function clickBoton4() {
  (0, _carrito.agregarProducto)("producto-4");
}

var botonUno = (0, _productos.obtenerBotonComprar)("producto-1");
botonUno.addEventListener("click", clickBoton1);
var botonDos = (0, _productos.obtenerBotonComprar)("producto-2");
botonDos.addEventListener("click", clickBoton2);
var botonTres = (0, _productos.obtenerBotonComprar)("producto-3");
botonTres.addEventListener("click", clickBoton3);
var botonCuatro = (0, _productos.obtenerBotonComprar)("producto-4");
botonCuatro.addEventListener("click", clickBoton4);
},{"./productos":"src/productos.js","./carrito":"src/carrito.js","./styles.css":"src/styles.css"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
